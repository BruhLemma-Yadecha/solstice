...
from .views import (
    VideoUploadAPIView,
    JobStatusAPIView,
    LatestVideoAndCSVAPIView,
    VideoDeleteAPIView,
    VideoRegenerateCSVAPIView,
    VideoListAPIView,
    JobListAPIView,
    JobDeleteAPIView,
)
...
urlpatterns = [
    ...
    path("jobs/<uuid:job_id>/delete/", JobDeleteAPIView.as_view(), name="job_delete"),
    path("latest/", LatestVideoAndCSVAPIView.as_view(), name="latest_video_and_csv"),
    path(
        "videos/<uuid:video_id>/delete/",
        VideoDeleteAPIView.as_view(),
        name="video_delete",
    ),
    path(
        "videos/<uuid:video_id>/regenerate-csv/",
        VideoRegenerateCSVAPIView.as_view(),
        name="video_regenerate_csv",
    ),
